...
const Card = ({title, description, id, modality, Rango_salarial, Rango_salarial1}) => {
    return (
    <div className="max-w-sm p-6 text-center bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
       ...
       <h4 className="text-gray-600 dark:text-gray-300">{Rango_salarial}-{Rango_salarial1}</h4>
