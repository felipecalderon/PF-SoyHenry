        ...
        <div className='flex flex-col items-center md:flex-row justify-center gap-6'>
          <div className="w-full max-w-sm p-4 bg-white border border-black rounded-lg shadow p-4 sm:p-8">
            ...
            <ul className="space-y-5 my-7">
              ...
              <li className="flex space-x-3 line-through decoration-gray-500">
                <svg aria-hidden="true" className="flex-shrink-0 w-5 h-5 text-gray-300 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Check icon</title><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
                <span className="text-base font-normal leading-tight text-gray-500">Poder ver todas las ofertas a la que aplicaste</span>
              </li>
            </ul>
          ...
          <div className="w-full max-w-sm p-4 bg-secondary-light rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            ...
            <ul className="space-y-5 my-7">
              ...
              <li className="flex space-x-3">
                <svg aria-hidden="true" className="flex-shrink-0 w-5 h-5 text-blue-50 dark:bg-primary-dark" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Check icon</title><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
                <span className="text-base font-normal leading-tight text-gray-500 dark:text-gray-400">Poder ver todas las ofertas a la que aplicaste</span>
              </li>
            </ul>
          </div>
