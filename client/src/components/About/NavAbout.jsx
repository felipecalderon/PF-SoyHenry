...
export const NavAbout = () => {
    ...
    // Creamos un estado para controlar si el menú modal está abierto o cerrado
    ...
    return (
    <nav className="bg-secondary-light dark:bg-primary-dark transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <div className="flex-shrink-0">
            <img
              className="h-10 w-auto relative ml-[5rem]"
              src={logofusionajob}
              alt="Workflow"
            />
          </div>
